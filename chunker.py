...
LANGUAGE_MAP = {
    ...
    ".h": {"grammar": tscpp, "function_node": "function_definition", "class_node": "class_specifier"},
    ...
    ".js": {"grammar": tsjs, "function_node": "function_declaration", "class_node": "class_declaration"},
    ".ts": {"grammar": tsts, "function_node": "function_declaration", "class_node": "class_declaration"},
...
def Find_Functions(file_path, root_node, function_lst, file_extension):
    for child in root_node.children:
        if child.type == LANGUAGE_MAP[file_extension]["function_node"]:
